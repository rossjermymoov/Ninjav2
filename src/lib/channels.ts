...
export const CHANNEL_FALLBACKS: Record<SalesChannel, ChannelData> = {
  amazon:      { slug: 'amazonsp',    displayName: 'Amazon',       colour: '#FF9900', logoUrl: null },
  ebay:        { slug: 'ebay',        displayName: 'eBay',         colour: '#E53238', logoUrl: null },
  shopify:     { slug: 'shopify',     displayName: 'Shopify',      colour: '#96BF48', logoUrl: null },
  etsy:        { slug: 'etsy',        displayName: 'Etsy',         colour: '#F1641E', logoUrl: null },
  woocommerce: { slug: 'woocommerce', displayName: 'WooCommerce',  colour: '#7F54B3', logoUrl: null },
  tiktok:      { slug: 'tiktokshop',  displayName: 'TikTok Shop',  colour: '#010101', logoUrl: null },
