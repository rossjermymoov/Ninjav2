...
export function TopBar() {
  ...
  return (
    <header
      className="fixed top-0 left-[145px] right-0 flex items-center z-30"
      style={{
        height: 80,
        background: '#171B2D',
    ...
    >
      ...
      {/* Search bar — fixed 280px matching Figma */}
      <div
      ...
      {/* Get a Quote button — Figma: 107px wide, height 35 */}
      <button
        className="shrink-0 transition-opacity hover:opacity-90"
        style={{
          background: '#1DFB9D', color: '#16122A',
          width: 107, height: 35, borderRadius: 20,
          fontFamily: M, fontSize: 12, fontWeight: 600,
          letterSpacing: '0.1px', whiteSpace: 'nowrap',
          border: 'none', cursor: 'pointer', marginLeft: 13,
        }}
      >
        Get a Quote
      </button>

      {/* Moov Freight button — Figma: 113px wide, height 35 */}
      <button
        className="shrink-0 transition-opacity hover:opacity-90"
        style={{
          background: '#1DFB9D', color: '#16122A',
          width: 113, height: 35, borderRadius: 20,
          fontFamily: M, fontSize: 12, fontWeight: 600,
          letterSpacing: '0.1px', whiteSpace: 'nowrap',
          border: 'none', cursor: 'pointer', marginLeft: 14,
        }}
      >
        Moov Freight
      </button>
      ...
      {/* Utility icons */}
      <div className="flex items-center shrink-0" style={{ gap: 14, marginLeft: 22 }}>
        <button className="flex items-center justify-center rounded-full hover:bg-white/10 transition-colors" style={{ width: 36, height: 36 }}>
          <IconMail />
        </button>
        <button className="flex items-center justify-center rounded-full hover:bg-white/10 transition-colors" style={{ width: 36, height: 36 }}>
          <IconCalendar />
      ...
      {/* Company name + Avatar */}
      <div className="flex items-center gap-3 shrink-0" style={{ marginLeft: 16 }}>
        <span style={{
